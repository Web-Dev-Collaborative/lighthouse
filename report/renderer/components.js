...
function createFooterComponent(dom) {
  ...
  const el4 = dom.createElement('ul', 'lh-meta__items');
  el4.append(' ');
  el3.append(' ', el4, ' ');
  const el5 = dom.createElement('div', 'lh-generated');
  const el6 = dom.createElement('b');
  el6.append('Lighthouse');
  const el7 = dom.createElement('span', 'lh-footer__version');
  const el8 = dom.createElement('a', 'lh-footer__version_issue');
  el8.setAttribute('href', 'https://github.com/GoogleChrome/Lighthouse/issues');
  el8.setAttribute('target', '_blank');
  el8.setAttribute('rel', 'noopener');
  el8.append('File an issue');
  el5.append(' ', ' Generated by ', el6, ' ', el7, ' | ', el8, ' ');
  el2.append(' ', ' ', el3, ' ', el5, ' ');
  el0.append(el2);
  return el0;
}
